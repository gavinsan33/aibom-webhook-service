...
Full rules for which Jobs/pods qualify, how JobSet siblings are merged, model/dataset auto-detection, and Prometheus telemetry retries are documented in `CLAUDE.md`.
